  ...
  return (
    <div className="pt-32 md:pt-40 pb-20 md:pb-32 bg-luxury-white min-h-screen">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <header className="mb-20 md:mb-32 text-center space-y-4 md:space-y-6">
          <p className="text-luxury-gold uppercase tracking-[0.4em] text-[10px] md:text-[11px] font-bold">The heritage</p>
          <h1 className="text-4xl sm:text-6xl md:text-[84px] font-serif text-luxury-navy italic leading-[0.95] font-bold">The Power House <br /> of Fashion</h1>
          <div className="w-24 md:w-32 h-[1px] bg-luxury-gold mx-auto mt-8 md:mt-12" />
        </header>

        <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center mb-24 md:mb-40">
          <motion.div 
          ...
          >
            <div className="aspect-[4/5] overflow-hidden rounded-[1.5rem] md:rounded-[2.5rem] shadow-[0_50px_100px_-20px_rgba(10,25,49,0.35)] transition-transform duration-700 group-hover:scale-[1.02]">
              <img 
            ...
            <div className="absolute -bottom-10 -left-10 w-48 md:w-64 h-48 md:h-64 bg-luxury-blue/5 rounded-full blur-3xl -z-10 animate-pulse" />
          </motion.div>
          <div className="space-y-8 md:space-y-10">
            <h2 className="text-3xl md:text-6xl font-serif italic text-luxury-navy leading-tight">Redefining Elegance for the <span className="text-luxury-gold">Modern Woman</span></h2>
            <p className="text-luxury-navy/60 font-light leading-relaxed text-lg md:text-xl italic">
              "Established in Kakamega, GF Collection began with a mission to empower through sophisticated fashion."
            </p>
            <p className="text-luxury-navy/70 font-light leading-loose text-base md:text-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-10 pt-10 border-t border-luxury-ice">
        ...
        <section className="relative mb-24 md:mb-40 overflow-hidden md:rounded-[3rem]">
           ...
           <div className="relative z-10 p-12 sm:p-16 md:p-32 text-center space-y-8 md:space-y-12">
            <div className="max-w-3xl mx-auto space-y-6 md:space-y-10">
              <p className="text-luxury-gold uppercase tracking-[0.4em] text-[9px] md:text-[10px] font-bold">The commitment</p>
              <h3 className="text-2xl sm:text-4xl md:text-6xl font-serif italic text-white leading-tight">"We believe that every woman deserves to feel like a Power House."</h3>
              <div className="w-12 md:w-16 h-[1px] bg-luxury-gold mx-auto" />
              <p className="text-[10px] md:text-[11px] uppercase tracking-[0.4em] font-bold text-white/60">The GF Collective Team</p>
            </div>
          </div>
        </section>
